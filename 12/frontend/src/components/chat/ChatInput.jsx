...
export const ChatInput = ({ value, onChange, onSend, disabled }) => {
  ...
  return (
    <div className="relative glass-panel p-2 flex items-end gap-2 glow-border mx-auto max-w-4xl w-full focus-within:ring-1 focus-within:ring-friday-accent transition-all">
