...
const ChatPage = () => {
  ...
  const handleSendMessage = async () => {
    ...
    try {
      ...
      // 5. Save AI response to DB & Update UI
      await supabase.from('messages').insert([{ conversation_id: currentConvId, user_id: user.id, role: 'assistant', content: data.response }]);
      ...
      const errorMsg = "FRIDAY Backend is unreachable. Please verify your FastAPI server is running and GEMINI_API_KEY is configured.";
